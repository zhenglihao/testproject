...
public class LogoHotUpdateActivity extends AppCompatActivity {
    private ImageView iv;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_logo_hot_update);
        ...
        tvFestival.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                switchIcon(1);
                iv.setBackgroundResource(R.mipmap.backgroud_about_banner);
                int badgeCount = 1;
        ...
        tvNormal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(LogoHotUpdateActivity.this, "App图标-普通版", Toast.LENGTH_SHORT).show();
            }
        });
    }
