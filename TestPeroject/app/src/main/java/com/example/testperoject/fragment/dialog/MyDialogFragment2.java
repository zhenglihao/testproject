...
import com.example.testperoject.util.DisplayUtils;
...
public class MyDialogFragment2 extends DialogFragment {
    ...
    private static MyDialogFragment2 fragment;
    ...
    public static MyDialogFragment2 newInstance() {
        if (fragment == null) {
            fragment = new MyDialogFragment2();
        }
        return fragment;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.from(getActivity()).inflate(R.layout.fragment_dialog2, container, false);
        return view;
    }
